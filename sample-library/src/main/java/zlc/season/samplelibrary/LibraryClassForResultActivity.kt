...
import kotlinx.android.synthetic.main.activity_library_class_for_result.*
import zlc.season.rxrouter.RxRouter

class LibraryClassForResultActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_library_class_for_result)
